// Comprehensive Firebase Rules Debugging Tool
import { collection, getDocs, query, where, orderBy, limit } from 'firebase/firestore';
import { auth } from './firebaseConfig';

export const debugFirebaseRules = async () => {
  console.log('🔍 COMPREHENSIVE FIREBASE DEBUGGING');
  console.log('=====================================');
...
if (typeof window !== 'undefined') {
  window.debugFirebaseRules = debugFirebaseRules;
}
